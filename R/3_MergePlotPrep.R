...
Mammalia_GB_count_10km_2_df <- readRDS("Counts.rds")
...
Mammalia_GB_count_10km_tab %>%
  ...
  dplyr::select(-c(Grey_urban:Waterbodies, Proportion_carolinensis, Proportion_vulgaris,
                   Proportion_marten, AllMammalia, year, CELLCODE)) -> d_cit
#output for the modells
saveRDS(d_cit, "citdata.rds")
#saveRDS(d_10kmmixed, "mixeddata.rds")
